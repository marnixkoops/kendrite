...
from kendrite import __version__ as release
...
latex_documents = [
    (master_doc, "kendrite.tex", "kendrite Documentation", "QuantumBlack", "manual",)
]
...
man_pages = [(master_doc, "kendrite", "kendrite Documentation", [author], 1,)]
...
texinfo_documents = [
    (
        master_doc,
        "kendrite",
        "kendrite Documentation",
        author,
        "kendrite",
        "Project kendrite codebase.",
        "Data-Science",
    )
]
